...
public class GameFrame extends JFrame {
	...
	static int bgWidth = 512, bgHeight = 768;//背景尺寸
...
//		System.out.println("绘制");
		...
		bi.drawImage(new ImageIcon("img/background333.JPG").getImage(), 0, -this.getSize().height+bgY, null);
		
		
		switch(gameState) {
			case 0://游戏开始前
				bi.drawImage(new ImageIcon("img/FengHuang0.png").getImage(), 50, 100, 412, 312, null);
